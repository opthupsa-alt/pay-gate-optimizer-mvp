...
interface ProviderClientProps {
  slug: string
  initialProvider?: ProviderWithRelations | null
...
export default function ProviderClient({ 
  ...
  const [provider, setProvider] = useState<ProviderWithRelations | null>(initialProvider)
  ...
  const coverUrl = provider.cover_image_url || "/providers/default-cover.svg"

  return (
    <div className="container mx-auto py-8 px-4">
      {/* Cover Image */}
      <div className="relative h-48 md:h-64 -mx-4 mb-8 overflow-hidden rounded-b-2xl">
        <Image
          src={coverUrl}
      ...
      <div className="mb-8">
        <div className="flex items-start gap-6 flex-wrap">
          {/* Logo */}
          <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-xl overflow-hidden border bg-background shadow-lg -mt-16 z-10">
            <Image
              src={logoUrl}
              alt={`${locale === "ar" ? provider.name_ar : provider.name_en} logo`}
              fill
                  ...
                  {(provider.setup_fee || provider.monthly_fee) && (
                    <div className="mt-6 pt-6 border-t">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {provider.setup_fee && Number(provider.setup_fee) > 0 && (
                        ...
                        {provider.monthly_fee && Number(provider.monthly_fee) > 0 && (
                          <div className="p-3 bg-muted rounded-lg">
                            <div className="text-sm text-muted-foreground">
