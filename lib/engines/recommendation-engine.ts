// Note: Supabase-based functions removed - using Prisma directly in API routes
...
// Note: calculateRecommendations and calculateRecommendationsExtended functions were removed
// as they used Supabase client directly. The API routes now use Prisma directly.
